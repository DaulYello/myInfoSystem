...
import com.personal.info.myInfoSystem.core.interceptor.AttributeSetInteceptor;
import com.personal.info.myInfoSystem.core.interceptor.RestApiInteceptor;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        if (myInfoProperties.getSwaggerOpen()) {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new RestApiInteceptor()).addPathPatterns("/systemApi/**");
    ...
    public JdkRegexpMethodPointcut druidStatPointcut() {
        ...
        String patterns = "com.personal.info.myInfoSystem.modular.*.service.*";
        //可以set多个
